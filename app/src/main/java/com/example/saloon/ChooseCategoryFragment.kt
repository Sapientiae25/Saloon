...
class ChooseCategoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        (activity as DefaultActivity).supportActionBar?.title = "Category"
        styleItem = arguments?.getParcelable("styleItem")!!
        imageList = arguments?.getStringArrayList("imageList") ?: arrayListOf<String>()
